...
export function Button({ color = "darkBlue", className, children, icon }) {
  const colors = {
  ...
  return (
    <button
      className={`${colors[color]} ${className} relative overflow-hidden px-8 py-3 md:py-4 rounded-xl md:rounded-2xl bg-gradient-to-b w-[270px] cursor-pointer glow-top transition-all duration-700 hover:-translate-y-1 active:translate-y-0 active:duration-300`}
    >
